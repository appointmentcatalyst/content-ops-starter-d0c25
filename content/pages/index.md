...
sections:
  ...
  - type: GenericSection
    ...
    media:
      ...
      type: ImageBlock
    badge:
      label: Lead Generation. Done Right.
      color: text-primary
      type: Badge
    elementId: ''
    colors: bg-light-fg-dark
  ...
  - type: FeaturedItemsSection
    ...
    actions: []
    badge:
      label: Why Choose Appointment Catalyst?
      color: text-primary
      styles:
        self:
          textAlign: center
  ...
  - title: Divider
    ...
    type: DividerSection
  - title:
      text: Flexibility That Puts You First
      color: text-dark
      styles:
        self:
          textAlign: center
      type: TitleBlock
    subtitle: 'English or Spanish, No Barriers'
    text: >+

      Our bilingual team ensures every lead is treated with clarity, respect,
      and professionalism. Whether your customers speak English or Spanish, our
      agents make sure the message is understood — increasing trust, reducing
      friction, and improving your close rates.
